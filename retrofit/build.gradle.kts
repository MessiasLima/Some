...
mavenPublishing {
    ...
    coordinates(artifactId = "some-retrofit")

    pom {
        name.set("Some Retrofit")
        description.set("Retrofit response integration for Some, a Kotlin test data generation library.")
